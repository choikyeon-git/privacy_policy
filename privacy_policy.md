...
본 앱은 시장분석 참고용이지 투자권유 앱이 아니며, 투자 선택의 책임은 사용자에 스스로에게 있음을 공지합니다.

## 1. 개인정보의 처리 목적
본 앱은 별도의 회원가입 절차 없이 서비스를 제공하며, 사용자의 민감한 개인정보를 직접 수집하거나 서버에 저장하지 않습니다. 단, 앱 서비스 제공 및 기능 개선을 위해 아래와 같은 정보를 활용할 수 있습니다.

## 2. 처리하는 개인정보의 항목
앱은 원활한 서비스 제공을 위해 다음과 같은 정보를 수집할 수 있습니다.
- **기기 정보:** 기기 모델명, OS 버전, 광고 식별자 (ADID/IDFA)
- **로그 데이터:** 앱 실행 기록, 오류 로그, 서비스 이용 기록
- **기타:** 구글 플레이 서비스 등 타사 라이브러리를 통해 수집되는 분석 정보

## 3. 제3자 서비스 및 데이터 수집
본 앱은 서비스 향상 및 광고 게재를 위해 다음과 같은 제3자 서비스를 이용할 수 있습니다. 각 서비스 제공업체는 자체적인 개인정보처리방침에 따라 정보를 수집합니다.
- [Google Play Services](https://www.google.com/policies/privacy/)
- [Google Analytics for Firebase](https://firebase.google.com/policies/analytics)
- [AdMob](https://support.google.com/admob/answer/6128543)

## 4. 개인정보의 보유 및 이용기간
본 앱은 원칙적으로 사용자의 개인정보를 직접 저장하지 않으므로 보유하지 않습니다. 제3자 서비스를 통해 수집된 정보는 해당 서비스 제공업체의 정책에 따라 보유 및 파기됩니다.

## 5. 이용자의 권리 및 의무
사용자는 언제든지 기기의 설정 메뉴를 통해 광고 식별자 수집을 거부하거나 앱을 삭제함으로써 정보 수집을 중단할 수 있습니다.

## 6. 개인정보의 안전성 확보 조치
앱은 사용자의 정보를 보호하기 위해 안드로이드 표준 보안 지침을 준수하며, 최신 보안 패치를 적용하기 위해 노력합니다. 

## 7. 개인정보 보호책임자 및 연락처
앱 이용 중 개인정보와 관련하여 문의사항이 있으시면 아래의 연락처로 문의해 주시기 바랍니다.

- **이메일:** [moc_revan@naver.com]
- **개발자/담당자:** [cho ik yeon]

## 8. 개인정보처리방침 변경 고지
본 방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경 내용의 추가, 삭제 및 수정이 있을 시에는 앱 내 또는 연결된 페이지를 통해 고지합니다.
